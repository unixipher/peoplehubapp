...
export default function BottomNav({ activeTab, setActiveTab }: BottomNavProps) {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-t border-slate-100 dark:border-slate-800/80 px-4 pt-3.5 pb-[calc(18px+env(safe-area-inset-bottom,0px))] flex justify-around items-center z-50 shadow-[0_-5px_15px_rgba(0,0,0,0.03)]">
      {tabs.map((tab) => {
        const Icon = tab.icon;

...
export default function BottomNav({ activeTab, setActiveTab }: BottomNavProps) {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-t border-slate-100 dark:border-slate-800/80 px-4 py-2 flex justify-around items-center z-50 shadow-[0_-5px_15px_rgba(0,0,0,0.03)] pb-safe">
      {tabs.map((tab) => {
        const Icon = tab.icon;
